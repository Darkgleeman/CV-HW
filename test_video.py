...
from train_video import training, Dataset
...
if __name__ == '__main__':
    ...
    device = "cuda"
    net = MCNN().to(device)
    net_dict = glob.glob('./model/partB/MSE_model_200_1e-05_20.ckpt')
    ...
    MSE_running_loss = []
    MAE_running_loss = []
    test_data = DataLoader(dataset=Dataset(), batch_size=batch_size, shuffle=False)
